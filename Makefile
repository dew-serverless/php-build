...
build-%:
	...
	docker buildx build $$BUILD_ARGS $(DOCKER_BUILD_EXTRA) -t dew/custom$$VARIANT-builder -f custom$$VARIANT-builder/Dockerfile . && \
	docker buildx build $$BUILD_ARGS $(DOCKER_BUILD_EXTRA) -t dew/$* -t ghcr.io/dew-serverless/php:$(subst php,,$*) -f $*/Dockerfile .
